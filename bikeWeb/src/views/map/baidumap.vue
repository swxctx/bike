<template>
    <!--地图容器-->
      <div style="left:15%;margin-right:30%;height:450px;border:#ccc solid 1px;" id="dituContent">
      </div>
</template>
...
<script>
  export default{
    ...
    //这几个地方加this
      ...
      //创建marker
      addMarker(){
        var markerArr = [{title:"Swxctx",content:"地址：深圳市宝安区西乡街道华侨新村<br/>电话：15776869842",point:"116.331398|39.897445",isOpen:1,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}];
